...
\usepackage[a4paper, top=2cm,bottom=15mm, left=2cm, right=2cm]{geometry} 
...
\begin{document}
\begin{center}
    \textbf{\Large{2. Würzburg Kanupoloturnier}\\\vspace{.5cm}
    \large{Spielplan}}
\end{center}
\thispagestyle{fancy}
% \section*{Die Teams}
...
\section*{ {{ day }} }
    \begin{table}[H]
        \centering
        \begin{tabular}{l{% if not swiss %}|l {% endif %}|l|l|lcl|l|l}
